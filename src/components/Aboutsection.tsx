    ...
    <section className="bg-white dark:bg-white min-h-screen py-5 px-8 sm:px-12 md:px-16 lg:px-25 flex flex-col gap-4">
      <div className="flex flex-col md:flex-row items-center gap-15">
        <div className="w-full text-center md:text-left md:w-1/2">
          <p className="text-[#146995] font-bold text-base sm:text-sm mb-4">About Us</p>
          <h4 className="text-3xl sm:text-lg md:text-3xl font-bold text-gray-900 mb-6 leading-snug">
          ...
          <p className="text-gray-700 text-base sm:text-sm leading-relaxed mb-8">
