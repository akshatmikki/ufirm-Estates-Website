...
export default function DotNetServicesPage() {
  ...
  return (
    <>
      {/* Fixed header — logo never hidden behind sidebar */}
      ...
      {/* pt-[80px] compensates for the fixed header */}
      <div className="relative z-40 pt-[80px] px-10 py-20 md:px-20 md:py-24">
        <BackgroundBeams />
        <div className="relative z-40 grid md:grid-cols-2 gap-10 items-start">
          <div>
            <h1 className="text-4xl font-bold text-white mb-6">
